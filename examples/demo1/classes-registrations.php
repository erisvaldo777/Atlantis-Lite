...
$CLASS         =  new Clients($_SESSION['CLIENT_ID']);
                                    ...
                                    <?php  if($_GET['action'] == 'update' || $_GET['action'] == 'create'){?>
                                        ...
                                        <form method="post">
                                            <div class="row">                            
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label>CEP</label>
                                                    <input type="text" class="form-control" <?= $CLASS->valueN("zip_code");?>"  required>
                                                </div>                            
                                                <div class="form-group col-md-12">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label>Cidade</label>
                                                    <input type="text" class="form-control" <?= $CLASS->valueN("city_name");?>"  required>
                                                </div>                            
                                                <div class="form-group col-md-12">
                                                    <label>Id uf</label>
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label>UF</label>
                                                    <input type="text" class="form-control" <?= $CLASS->valueN("state_abbr");?>"  required>
                                                </div>                            
                                                <div class="form-group col-md-12">
