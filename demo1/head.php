...
<head>
	...
	<title>CORTEX - Sistema de Prospecção</title>
	...
	<script>
		WebFont.load({
			...
			custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands", "simple-line-icons"], urls: ['/cdn/css/fonts.min.css']},
			active: function() {
