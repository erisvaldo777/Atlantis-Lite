												...
												<tbody>
													...
													<?php }else{ foreach($ROWS as $k => $v){?>
														<tr>
															...
															<td><?= $v['status_name'];?></td>
															<td class="text-right">
																<a href="<?= $v['user_id'];?>/update" class="btn btn-success btNewImage"><i class="fa fa-edit"></i></a>
																<a href="/admin/principal/rules/<?= $v['user_id'];?>/list" class="btn btn-warning"><i class="fa fa-edit"></i></a>
